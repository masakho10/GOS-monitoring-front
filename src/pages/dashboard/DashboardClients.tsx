...
const DashboardClients = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const successRes = await axios.get('http://localhost:3001/api/clients_success_log');
        const errorRes = await axios.get('http://localhost:3001/api/clients_error_log');
        const rateRes = await axios.get('http://localhost:3001/api/clients_success_percentage');
